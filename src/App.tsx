...
function App() {
  //토큰
  const TOKEN: string = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiI4OSIsImlhdCI6MTY3Mzk0MDAzNSwiZXhwIjoxNjczOTQ3MjM1fQ.Y9ZiRh2uSkOifkMAHui75yi55OJ62-qMHWoD-NmW2wI";
  // 로컬 서버 URL
  ...
  const onClickDownloadFile = async () => {
    ...
    await axios({
      url: `${BASE_URL}/api/sign-image/recent`,
      method: "GET",
      responseType: "blob",
    }).then((response) => {
  ...
  return (
    <Container>
      ...
      <Box sx={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column" }}>
        <Button onClick={onClickDownloadFile} sx={{ display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column" }}>
          <Box>
